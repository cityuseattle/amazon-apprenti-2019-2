...
app.get('/birthday-card/:id', fetch_birthday_card_1.default);
app.put('/book', update_book_1.default);
app.put('/birthday-card', update_birthday_card_1.default);
app.delete('/book/:id', delete_book_1.default);
app.delete('/birthday-card/:id', delete_birthday_card_1.default);
