...
var Book = /** @class */ (function () {
    ...
    Book = __decorate([
        dynamodb_data_mapper_annotations_1.table('module9Books')
    ], Book);
    return Book;
}());
exports.Book = Book;
...
function updateBook(id, title, isbn, author, picture, price) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, dynamodbmapper_1.default.update(Object.assign(new Book, { _id: id, title: title, isbn: isbn, author: author, picture: picture, price: price }))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
function fetchBook(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dynamodbmapper_1.default.get(Object.assign(new Book, { _id: id }))];
                case 1:
                    book = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, dynamodbmapper_1.default.delete(Object.assign(new Book, { _id: id }))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
function findBook(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dynamodbmapper_1.default.get(Object.assign(new Book, { id: id }))];
                case 1:
                    user = _a.sent();
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    _b = __asyncValues(dynamodbmapper_1.default.scan(Book));
                    _d.label = 2;
