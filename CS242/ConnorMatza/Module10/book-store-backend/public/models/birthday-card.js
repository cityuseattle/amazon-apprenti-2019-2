...
var BirthdayCard = /** @class */ (function () {
    ...
    ], BirthdayCard.prototype, "_id", void 0);
    __decorate([
    ...
    BirthdayCard = __decorate([
        dynamodb_data_mapper_annotations_1.table('birthdaycards2')
    ], BirthdayCard);
    return BirthdayCard;
}());
...
function updateBirthdayCard(id, title, material, picture, price) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, dynamodbmapper_1.default.update(Object.assign(new BirthdayCard, { _id: id, title: title, material: material, picture: picture, price: price }))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
exports.updateBirthdayCard = updateBirthdayCard;
function deleteBirthdayCard(id) {
    return __awaiter(this, void 0, void 0, function () {
        var e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, dynamodbmapper_1.default.delete(Object.assign(new BirthdayCard, { _id: id }))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
exports.deleteBirthdayCard = deleteBirthdayCard;
function fetchBirthdayCard(id) {
    return __awaiter(this, void 0, void 0, function () {
        var birthdaycard;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dynamodbmapper_1.default.get(Object.assign(new BirthdayCard, { _id: id }))];
                case 1:
                    birthdaycard = _a.sent();
                    return [2 /*return*/, birthdaycard];
            }
        });
    });
}
exports.fetchBirthdayCard = fetchBirthdayCard;
