...
var Product = /** @class */ (function () {
    ...
    Product = __decorate([
        dynamodb_data_mapper_annotations_1.table('products')
    ], Product);
    return Product;
}());
exports.Product = Product;
function createProduct(title, weight, price, amount, providers) {
    mapper_1.default.put(Object.assign(new Product, { title: title, weight: weight, price: price, amount: amount, providers: providers }))
...
function findProduct(title) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mapper_1.default.get(Object.assign(new Product, { title: title }))];
                case 1:
                    user = _a.sent();
