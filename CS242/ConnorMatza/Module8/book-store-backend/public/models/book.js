...
exports.Book = Book;
function addBook(title, isbn, author, picture, providers) {
    dynamodbmapper_1.default.put(Object.assign(new Book, { title: title, isbn: isbn, author: author, picture: picture, }))
