...
app.post("/submitProduct", new_product_controller_1.default);
app.get("/findProduct", find_product_controller_1.default);
app.listen(3000, function () {
    return console.log("The server is running on http://localhost:3000");
});
