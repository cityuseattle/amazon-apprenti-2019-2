...
def pay(request, payment_type="Credit or Debit",discount=0):
...
def help(request):
    contact_name = 'Team G'
    contact_address = {'sector':'521','city':'Wall St ','planet':'Seattle'}
...
def add_payment(request):
    title = 'Add Payment Method For Faster Checkout'
