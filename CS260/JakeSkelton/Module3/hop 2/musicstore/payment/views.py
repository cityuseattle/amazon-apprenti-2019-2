...
def help(request):
    ...
    contact_info = {'contact_name':contact_name, 'contact_address':contact_address, 'contact_phone':contact_phone,}
...
def refund(request):
    ...
    contact_hours = ((0,'Mon-Thu 7AM-12PM'), (1,'Fri 1PM-5PM'),(2,'Sat-Sun 7AM-10AM'))
    contact_info = {'contact_name':contact_name, 'contact_address':contact_address, 'contact_phone':contact_phone,}
    return TemplateResponse(request,'payment/helprefund.html', contact_info)
