...
def help(request):
    contact_name = 'Dustin'
    contact_address = {'sector': '#385' , 'city': 'Sabody' , 'planet':'Earth'}
    contact_phone = ['(123) 456-789', '(987) 654-3210']
    contact_hours = ((0, 'Mon-Thu 7AM-12PM') , (1, 'Fri 1PM-5PM') , (2,'Sat-Sun 7AM-10AM'))
    #Dictionary of all the variables
    contact_info = {'conatct_name': contact_name, 'contact_address': contact_address, 'contact_phone':contact_phone, 'contact_hours': contact_hours}
