...
def add_payment(request):
    ...
    # DJANGO default request.method = GET !!!!!!!!!!!!!!

    if request.method == 'POST':
        # POST, generate form with data from the user injput POST request
    ...
    # returns 3 things: request, url template to display, and the python variable dictionary with values to use in HTML for display
