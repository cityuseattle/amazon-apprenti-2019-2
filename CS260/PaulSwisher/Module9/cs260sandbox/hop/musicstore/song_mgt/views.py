...
def add_song(request):
    ...
    # Extract form values
            ...
            try:
                models.create_process(title, artists, album, genre, year, album_image)
...
# Fetch the song from the DB based on the given id, and then populate the fields 
            ...
            form = forms.EditSongForm(auto_id=False, initial={'id':song.id,'title':song.title,
            ...
            form = forms.EditSongForm(request.POST)
# Call is_valid() to validate data and create cleaned_data and errors dict
...
# Extract form values
            ...
            album_image = form.cleaned_data['album_image']
            try:
                models.edit_process(id, title, artists, album, genre, year, album_image)
