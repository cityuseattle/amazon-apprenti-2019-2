...
const array = [3, 7, 4];
const mappedArray = array.map((item:number) => item + 1);
...
let verbs: {positive: boolean, content: string}[] = [
    {positive: true, content: 'treat'},
    {positive: true, content: 'praise'},
    {positive: false, content: 'dropkick'},
    {positive: true, content: 'help'},
    {positive: false, content: 'punch'}
];
